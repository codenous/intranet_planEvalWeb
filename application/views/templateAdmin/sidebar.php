<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
            <a href="#">
                <i class="fa fa-shopping-cart" aria-hidden="true"></i> <span>Pagos</span> <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="treeview-menu">
                <li><a href="<?php echo base_url()?>jardines/Index/registroPago"><i class="fa fa-circle-o text-aqua"></i> Registrar Pagos</a></li>
                <li><a href="<?php echo base_url()?>jardines/Index/listadoPago"><i class="fa fa-circle-o text-aqua"></i> Listado Pagos</a></li>
            </ul>
        </li>
      </ul>
    </section>
